...
@everywhere begin
    ...
    enddate = "2017-02-15" # Select End Date
...
safe_download(aws, bucket2, list_csv, "~/") # Retain seisbasin filepathing
...
for station in stations
    ...
    println("$(length(filelist)) correlations to be processed for station $source_station")
